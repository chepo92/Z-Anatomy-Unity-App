...
public class ReadDB : MonoBehaviour
{
    ...
    {
        string[] fr = { "== Galerie ==", "== Voir aussi ==", "== R�f�rences ==", "== Notes et R�f�rences ==", "== Liens externes ==" };
        string[] es = { "== Im�genes adicionales ==", "== V�ase tambi�n ==", "== Referencias ==", "== Bibliograf�a ==", "== Enlaces externos ==" };
        string[] pt = { "== Imagens ==", "== Ver tamb�m ==", "== Refer�ncias ==", "== Notas e refer�ncias ==", "== Liga��es externas ==" };
