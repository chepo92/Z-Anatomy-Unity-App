...
public class CrossSections : MonoBehaviour
{
    ...
    private List<Renderer> affectedRenderers;
    private Dictionary<Renderer, Material[]> originalMaterials;
    private Dictionary<Renderer, Material[]> doubleSidedeMaterials;
    ...
    private void Start()
    {
        ...
        doubleSidedeMaterials = new Dictionary<Renderer, Material[]>();
        affectedRenderers = new List<Renderer>();
